...
Stacked v2.2 feature branches are cleaned up with `docs/governance/branch_cleanup_runbook.md`. That runbook never deletes this release branch or the `v2.2*` tags.
