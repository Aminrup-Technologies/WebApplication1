                ...
                <div class="col col-lg-10 col-lg-offset-1">
                    ...
                    <div class="features-grids">
                        <div class="grid">
                            ...
                            <p>
                                <asp:Label ID="lbl_business_insights" runat="server" Text="Label"></asp:Label>
                            </p>
                        </div>
                        <div class="grid">
                            <div class="icon">
                            ...
                            <p>
                                <asp:Label ID="lbl_Market_reacherch" runat="server" Text="Label"></asp:Label>
                            </p>
                        </div>
                        <div class="grid">
                            <div class="icon">
                            ...
                            <p>
                                <asp:Label ID="lbl_Thought_leadership" runat="server" Text="Label"></asp:Label>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col col-xs-12">
                    <div class="team-grids clearfix">
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3>
                                    <asp:Label ID="lbl_Team_Member1" runat="server" Text="Label"></asp:Label></h3>
                                <span>Engineer</span>
                            </div>
                        </div>
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3>
                                    <asp:Label ID="lbl_Team_Member2" runat="server" Text="Label"></asp:Label></h3>
                        ...
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3>
                                    <asp:Label ID="lbl_Team_Member3" runat="server" Text="Label"></asp:Label></h3>
                                <span>Founder</span>
                            </div>
                        </div>
                        <div class="grid">
                            ...
                            <div class="details">
                                <h3>
                                    <asp:Label ID="lbl_Team_Member4" runat="server" Text="Label"></asp:Label></h3>
