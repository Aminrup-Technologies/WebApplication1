    ...
    public partial class emp_payrollcategory : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        string CmdString2 = "select * from tlb_payroll_category where Country_Code='IN' and State_Code='"+ state + "' and WorkRegion_Code='"+ region + "' and Company_Code='"+ comp + "' order by Id";
                        BindGrid(CmdString2);
                    }
                }
            }
        ...
        protected void DDL_WorkCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string CmdString2 = "select * from tlb_payroll_category where Country_Code = 'IN' and State_Code='" + state + "' and WorkRegion_Code ='" + region + "' order by Id";
                BindGrid(CmdString2);
            }
        }
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (deptname != string.Empty && deptcode != string.Empty)
            {
                try
                {
                    ...
                    string CmdString2 = "select * from tlb_payroll_category where WorkRegion_Code = '" + region + "' AND Company_Code='"+ Session["COMPANY_CODE"].ToString() + "' order by Id";
                    BindGrid(CmdString2);
        ...
        protected void DDL_Company_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                string CmdString2 = "select * from tlb_payroll_category where Country_Code = 'IN' and State_Code ='" + state + "' and WorkRegion_Code='" + region + "' and Company_Code = '" + Session["COMPANY_CODE"].ToString() + "' order by Id";
                BindGrid(CmdString2);
            }
        }
    }
