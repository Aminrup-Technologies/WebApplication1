...
namespace WebApplication1.bussiness.production
{
    public partial class create_jobid_v2 : System.Web.UI.Page
    {
        ...
        private string WO_MasterStatusCode { get { return ViewState["WO_MasterStatusCode"] as string ?? JobStatusConstants.Status1; } set { ViewState["WO_MasterStatusCode"] = value; } }
        ...
        */
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(generatedJobId))
            {
                ...
                // V2 DYNAMIC ROUTING
                if (WO_MasterStatusCode == JobStatusConstants.Status3)
                {
        ...
        private string Insert_JOBData()
        {
            lock (jobInsertLock)
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@EntryExit", JobStatusConstants.Created);
                    ...
                    else
                    {
                        ...
                        cmd.Parameters.AddWithValue("@JOB_Status", JobStatusConstants.Created);
