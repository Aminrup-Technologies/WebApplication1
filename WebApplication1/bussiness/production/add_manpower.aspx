<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="add_manpower.aspx.cs" Inherits="WebApplication1.bussiness.production.add_manpower" %>
		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h5>Search & Add Manpower to JOB ID | <asp:Label ID="lbl_month" runat="server"></asp:Label><asp:Label ID="lbl_monthcode" Visible="false" runat="server"></asp:Label>, <asp:Label ID="lbl_year" runat="server"></asp:Label></h5>
				</div>
			</div>
					...
					<div class="x_panel">
						...
						<div class="x_content">
							<div class="row">
                                ...
                                <div class="col-md-3 col-sm-3 col-xs-3 form-group">
									<asp:DropDownList ID="DDL_Worksites" CssClass="form-control form-control-sm rounded" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DDL_Worksites_SelectedIndexChanged"></asp:DropDownList>
								</div>

                                <div class="col-md-3 col-sm-3 col-xs-3 form-group">
									<label>Select Supervisor <span class="text text-danger">*</span></label>
								</div>

                                <div class="col-md-3 col-sm-3 col-xs-3 form-group">
									<asp:DropDownList ID="DDL_Supervisor" CssClass="form-control form-control-sm rounded" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DDL_Supervisor_SelectedIndexChanged"></asp:DropDownList>
								</div>
					...
					<asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
						<Columns>
							...
							<asp:TemplateField HeaderText="Approver Name" HeaderStyle-Width="10%">
								<ItemTemplate>
									<asp:Label ID="lbl_JOB_InchargeName" runat="server" Font-Bold="true" Text='<%# Eval("JOB_InchargeName") %>' />
								</ItemTemplate>
								<ItemStyle CssClass="text text-center" />
							</asp:TemplateField>
