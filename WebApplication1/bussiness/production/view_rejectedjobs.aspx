<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="view_rejectedjobs.aspx.cs" Inherits="WebApplication1.bussiness.production.view_rejectedjobs" %>
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h5>View & Manage : Approved JOB's & Manpower</h5>
                </div>
            ...
            <div class="row">
                <div class="card-box col-md-12 col-sm-12 small" style="width: 100%; height: 450px; overflow: scroll;">
                    <asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="JOB ID" HeaderStyle-Width="5%">
                                <ItemTemplate>
                                    <asp:Button ID="btn_viewdetails" runat="server" Enabled="false" Text='<%# Eval("JOBID") %>' Font-Size="Smaller" CssClass="btn btn-sm btn-info" CommandName="Approve" CommandArgument="<%# Container.DataItemIndex %>" />
                            ...
                            <asp:TemplateField HeaderText="JOBID Status" HeaderStyle-Width="5%">
                                <ItemTemplate>
                                    <asp:Button ID="btn_jobidstatus" runat="server" Enabled="false" Text='<%# Eval("JOBID_Status") %>' Font-Size="Smaller" CssClass="btn btn-sm btn-info" CommandName="Swap_JOBIDStatus" CommandArgument="<%# Container.DataItemIndex %>" />
                            ...
                            <asp:TemplateField HeaderText="JOB Site" HeaderStyle-Width="8%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="JOB Title / Work Permit Description" HeaderStyle-Width="20%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Approval Status" Visible="true"  HeaderStyle-Width="5%">
                                <ItemTemplate>
