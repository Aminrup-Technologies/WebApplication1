<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="RolesOverview.aspx.cs" Inherits="WebApplication1.bussiness.production.RolesOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        const myEmbeddedId = "635c4803-6e48-4758-a52a-a5f2a3cf484c"; 
        ...
        async function fetchGuestTokenFromBackend() {
            try {
                ...
                const response = await fetch('RolesOverview.aspx/FetchSupersetGuestToken', {
                    method: 'POST',
                    headers: {
