		...
		<div class="">
			<div class="page-title">
				<div class="title_left">
					<h5>View & Manage Employee Payroll Inputs || <asp:Button ID="Button1" runat="server" Text="Export" CssClass="btn btn-primary btn-sm" OnClick="ExportExcel"/></h5>
				</div>
				...
				<div class="col-md-12 col-sm-12 small" style="width: 100%; height: 450px; overflow: scroll">
					<asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive nowrap" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating">
						<Columns>
							...
							<asp:TemplateField HeaderText="W SL" HeaderStyle-Width="3%">
								<ItemTemplate>
							...
							<asp:TemplateField HeaderText="Skill Category" HeaderStyle-Width="12%">
								<ItemTemplate>
							...
							<asp:TemplateField HeaderText="Fixed Amount" HeaderStyle-Width="5%" Visible="true">
								<ItemTemplate>
									<asp:Label ID="lbl_FixedAmount" runat="server" Text='<%# Bind("FixedAmount") %>'></asp:Label>
								</ItemTemplate>
								<EditItemTemplate>
									<asp:TextBox ID="txt_FixedAmount" runat="server" Text='<%# Bind("FixedAmount") %>' CssClass="form-control form-control-sm rounded" Width="100%"></asp:TextBox>
								</EditItemTemplate>
								<HeaderStyle CssClass="grid" />
								<ItemStyle CssClass="grid" />
							</asp:TemplateField>
