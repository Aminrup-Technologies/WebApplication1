<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="gen_ninl_f17.aspx.cs" Inherits="WebApplication1.bussiness.production.gen_ninl_f17" %>
                ...
                <div class="card-box col-md-12 col-sm-12 small" style="width: 1100px; height: 450px; overflow: scroll;">
                    <asp:GridView ID="GridView" runat="server" Width="100%" CssClass="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnDataBound="GridView_DataBound">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Conv Pay" HeaderStyle-Width="2%" Visible="true">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Others Pay" HeaderStyle-Width="2%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="NETPay - 1" HeaderStyle-Width="2%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Advance" HeaderStyle-Width="2%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Total Deductions" HeaderStyle-Width="2%">
                                <ItemTemplate>
                                    <asp:Label ID="lbl_grossded" runat="server"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle CssClass="grid" />
                                <ItemStyle CssClass="grid" />
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Final NetPay-1" HeaderStyle-Width="2%">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="NETPay - 2" HeaderStyle-Width="2%">
                                <ItemTemplate>
