<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="vw_lineitemjobs.aspx.cs" Inherits="WebApplication1.bussiness.production.vw_lineitemjobs" %>
		...
		<div class="container">
			<div class="page-title">
				<div class="title_left">
					<h5>Line Item JOBID's - <asp:Label ID="lbl_month" runat="server"></asp:Label><asp:Label ID="lbl_monthcode" Visible="false" runat="server"></asp:Label>, <asp:Label ID="lbl_year" runat="server"></asp:Label></h5>
				</div>
					...
					<asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand">
						<Columns>
							...
							<asp:TemplateField HeaderText="Create" HeaderStyle-Width="5%">
								<ItemTemplate>
									<asp:Button ID="btn_createLineItemmemo" runat="server" Text='LINE ITEM MEMO' Font-Size="Smaller" CssClass="btn btn-sm btn-warning" CommandName="CLIMEM" CommandArgument="<%# Container.DataItemIndex %>" />
