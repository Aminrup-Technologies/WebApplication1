<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="generate_appvrsite_atdncsheet.aspx.cs" Inherits="WebApplication1.bussiness.production.generate_appvrsite_atdncsheet" ValidateRequest="false" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-12  form-group">
                                    <asp:DropDownList ID="DDL_ReportType" CssClass="form-control form-control-sm rounded" runat="server">
                                        ...
                                        <asp:ListItem Value="3">Combined Sheet 1</asp:ListItem>
