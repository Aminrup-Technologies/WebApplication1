<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="CSMDocShiftOverview.aspx.cs" Inherits="WebApplication1.bussiness.production.CSMDocShiftOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        // ==========================================
        // SUPERSET EMBEDDING LOGIC
        // ==========================================
        
        // TODO: Paste the Embedded ID you generated in the Superset Admin UI here
        const myEmbeddedId = "1b5d395c-02af-4864-b78f-ec0a1dbd147d"; 
        ...
        async function fetchGuestTokenFromBackend() {
            try {
                ...
                const response = await fetch('CSMDocShiftOverview.aspx/FetchSupersetGuestToken', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    // CRITICAL FIX: ASP.NET requires an empty JSON body for parameterless WebMethods
                    body: "{}" 
                });
                ...
                // ASP.NET WebMethods wrap returns in a 'd' property
        ...
        // Initialize the embedding process once the page loads
