                            ...
                            <div class="col-md-6 center-margin">
                                ...
                                <div class="item form-group row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <asp:Button ID="btn_submit" runat="server" Text="Generate" CssClass="btn btn-success btn-sm" OnClientClick="return ValidateFormField()" OnClick="btn_submit_Click" />
                                    </div>
                                </div>
                            </div>
                            <%--button   end--%>
