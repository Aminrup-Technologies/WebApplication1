							...
							<div class="novalidate" id="InpunchPanel_Row" runat="server" visible="true">
								...
								<div class="field item form-group" id="EmployeeName_Row" runat="server" visible="false">
									...
									<div class="col-md-6 col-sm-6">
										...
										<asp:Label ID="lbl_designation" runat="server" Text="" Visible="false"><asp:Label ID="lbl_designationcode" runat="server" Text="" Visible="true"></asp:Label>
								...
								<div class="field item form-group" id="OTRow" runat="server" visible="false">
									...
									<div class="col-md-6 col-sm-6">
										<asp:TextBox ID="txt_ot" runat="server" CssClass="form-control form-control-sm rounded"></asp:TextBox>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="ADDTOLIST" runat="server" ErrorMessage="Reqired" ControlToValidate="txt_ot" Display="Dynamic" CssClass="text text-warning" SetFocusOnError="True"></asp:RequiredFieldValidator>
									</div>
								</div>
