<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="ViolationsOverview.aspx.cs" Inherits="WebApplication1.bussiness.production.ViolationsOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        const myEmbeddedId = "ab1b802a-4bda-4b4d-84e8-792484030cdb"; 
        ...
        async function fetchGuestTokenFromBackend() {
            try {
                ...
                const response = await fetch('ViolationsOverview.aspx/FetchSupersetGuestToken', {
                    method: 'POST',
                    headers: {
