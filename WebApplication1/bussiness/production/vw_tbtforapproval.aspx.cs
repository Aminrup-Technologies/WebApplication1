...
namespace WebApplication1.bussiness.production
{
    public partial class vw_tbtforapproval : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + DateTime.Now.Year.ToString() + "' and MONTH(TBT_Date)='" + DateTime.Now.Month.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);

                    viewerid = "vw2";

                    //string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' order by TBT_Date desc";
                    //BindGrid(CmdString2);
        ...
        protected void JOBID_Delete(string id, string dbcode)
        {
            ...
            string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and JOB_InchargeName='" + Session["USERNAME"].ToString() + "' and SafetySupvApprovalStatus='Pending' order by TBT_Date desc"; BindGrid(CmdString2);
        ...
        private void GridBinder(string Year, string Month)
        {
            ...
            {
                string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' order by TBT_Date desc";
                BindGrid(CmdString2);
            }
            else if (DDL_TBTStatus.SelectedIndex != 0 && DDL_TBTDept.SelectedIndex == 0)
            {
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and Panel2_Status='Complete' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBTPhoto!='Uploaded' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Returned' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                else if (DDL_TBTStatus.SelectedValue == "8")
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Rejected' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
            }
            else if (DDL_TBTStatus.SelectedIndex == 0 && DDL_TBTDept.SelectedIndex != 0)
            {
                string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                BindGrid(CmdString2);
            }
            else if (DDL_TBTDept.SelectedIndex != 0 && DDL_TBTStatus.SelectedIndex != 0)
            {
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and Panel2_Status='Complete' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                else if (DDL_TBTStatus.SelectedValue == "2")
                {
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Pending' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBTPhoto!='Uploaded' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                else if (DDL_TBTStatus.SelectedValue == "4")
                {
                ...
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Approved' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                else if (DDL_TBTStatus.SelectedValue == "7")
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Returned' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
                else if (DDL_TBTStatus.SelectedValue == "8")
                {
                    string CmdString2 = "select * from tbl_toolboxtalkdata where SafetySupvWrk='" + Session["WORKMAN"].ToString() + "' and SafetySupvApprovalStatus='Rejected' and YEAR(TBT_Date)='" + Year + "' and MONTH(TBT_Date)='" + Month + "' and TBT_Dept='" + DDL_TBTDept.SelectedValue.ToString() + "' order by TBT_Date desc";
                    BindGrid(CmdString2);
                }
            }
        }
