<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="vw_supplyjobs.aspx.cs" Inherits="WebApplication1.bussiness.production.vw_supplyjobs" %>
		...
		<div class="container">
			<div class="page-title">
				<div class="title_left">
					<h5>Manpower Supply JOBID's - <asp:Label ID="lbl_month" runat="server"></asp:Label><asp:Label ID="lbl_monthcode" Visible="false" runat="server"></asp:Label>, <asp:Label ID="lbl_year" runat="server"></asp:Label></h5>
				</div>
