        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h5>View Selected JOBID Details & Approval Process</h5>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 col-sm-6  form-group">
                                    <asp:TextBox ID="txt_jobid" class="form-control form-control-sm rounded" runat="server" ReadOnly="true"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-md-2 col-sm-12 form-group" id="worksite_row1" runat="server" visible="false">
                                    <label>Select New Work-Site<span class="text text-danger">*</span></label>
                                </div>
                                <div class="col-md-2 col-sm-12 form-group" id="worksite_row2" runat="server" visible="false">
                                ...
                                <div class="col-md-2 col-sm-12 form-group" id="approver_row1" runat="server" visible="false">
                                    <label>Select New Approver<span class="text text-danger">*</span></label>
                                </div>
                                <div class="col-md-2 col-sm-12 form-group" id="approver_row2" runat="server" visible="false">
                                ...
                                <div class="col-md-2 col-sm-12  form-group">
                                    ...
                                    <asp:TextBox ID="txt_permitno" runat="server" ReadOnly="true" Font-Bold="true" ForeColor="Brown" MaxLength="100" class="form-control form-control-sm rounded">
                                    </asp:TextBox>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>JOB Attached Permit Data View</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="table-responsive">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" Font-Size="Smaller" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive nowrap" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found" OnRowDeleting="GridView1_RowDeleting">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="DownloadStatus" HeaderStyle-Width="5%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lbl_DownloadStatus" runat="server" Text='<%# Eval("DownloadStatus").ToString() == "1" ? "Yes" : "No" %>' />
                                                    </ItemTemplate>
                                                    <HeaderStyle CssClass="GridHeaderText-Center" />
                                                    <ItemStyle CssClass="text text-center" />
                                                </asp:TemplateField>
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>JOB Attached Manpower Data View</h2>
                            <ul class="nav navbar-right panel_toolbox">
                                <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
                                <%--<li><a class="close-link"><i class="fa fa-close"></i></a></li>--%>
                            </ul>
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12 form-group" runat="server" visible="true">
                                    <label>Attendance Code (Applicable for ALL Manpower)</label>
                                </div>
                                <div class="col-md-3 col-sm-12  form-group" runat="server" visible="true">
                                    <asp:DropDownList ID="DDL_AttenCode" runat="server" CssClass="form-control form-control-sm rounded" Enabled="false"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RFV3" ValidationGroup="Approve" runat="server" CssClass="text text-warning" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="DDL_AttenCode" SetFocusOnError="true" InitialValue="Please Select Option" ToolTip="Kindly select value"></asp:RequiredFieldValidator>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-12  form-group">
                                    ...
                                    <asp:RequiredFieldValidator ID="RFV1" ValidationGroup="Approve" runat="server" CssClass="text text-warning" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="DDL_BillingType" SetFocusOnError="true" ToolTip="Kindly select value"></asp:RequiredFieldValidator>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-12  form-group">
                                    <asp:TextBox ID="txt_remarks" class="form-control form-control-sm rounded" Text="N/A" runat="server"></asp:TextBox>
                                </div>

                                <div class="col-md-3 col-sm-12" id="addattenrow1" runat="server" visible="false">
								...
								<div class="col-md-3 col-sm-12  form-group">
									<asp:DropDownList ID="DDL_AttenType" runat="server" CssClass="form-control form-control-sm rounded"></asp:DropDownList>
									<asp:RequiredFieldValidator ID="RFV2" ValidationGroup="Approve" runat="server" CssClass="text text-warning" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="DDL_AttenType" SetFocusOnError="true" InitialValue="Please Select Option" ToolTip="Kindly select value"></asp:RequiredFieldValidator>
								</div>--%>
                            </div>
                            ...
                            <div class="col-md-6 center-margin">
                                ...
                                <div class="item form-group row">
                                    <div class="col-md-6 col-sm-12">
                                        <asp:Label ID="lbl_finalmsg" runat="server" Font-Bold="true" Text="Click to Proceed..!"></asp:Label>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                        <%--<button type="reset" class="btn btn-warning btn-sm collapse-link">Cancel</button>--%>
                                        <asp:Button ID="btn_cancel" runat="server" Text="Cancel" CssClass="btn btn-warning btn-sm" OnClick="btn_cancel_Click" />
                                        <asp:Button ID="btn_reject" runat="server" Text="Reject" CssClass="btn btn-danger btn-sm" OnClientClick="return confirm('Are you sure you want to REJECT...?')" OnClick="btn_reject_Click" />
                                        <asp:Button ID="btn_approve" runat="server" Text="Approve" CssClass="btn btn-success btn-sm" OnClientClick="return confirm('Are you sure you want to APPROVE...?')" OnClick="btn_approve_Click" ValidationGroup="Approve" CausesValidation="true" />
                                    </div>
                                </div>
                            </div>
                            <%--button end--%>
