<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeBehind="vw_csm_toolboxtalkdetails.aspx.cs" Inherits="WebApplication1.bussiness.production.vw_csm_toolboxtalkdetails" %>
						...
						<div class="x_content">
							<div class="row" id="jobselectionpanel" runat="server" visible="true">
								...
								<div class="col-md-12 col-sm-12  form-group" id="JOBIDDetails_Row" runat="server" visible="false">
									...
									JOB Shift :
									<asp:Label ID="lbl_jobshift" runat="server" Text="Label" ForeColor="Green" Font-Bold="true"></asp:Label>; Department :
										<asp:Label ID="lbl_dept" runat="server" Text="Label" ForeColor="Black" Font-Bold="true" Visible="true"></asp:Label>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12  form-group" id="jobsupv" runat="server" visible="false">
									...
									<div class="col-md-6 col-sm-6">
										...
										<asp:Label ID="lbl_supvwrk" runat="server" Text="" Visible="false"></asp:Label>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12  form-group" id="sftyofcrrow" runat="server" visible="false">
									...
									<div class="col-md-6 col-sm-6">
										<asp:DropDownList ID="DDL_SftyOfcr" runat="server" class="form-control form-control-sm rounded" Enabled="false"></asp:DropDownList>
										...
										<asp:Label ID="lbl_sftyofcrwrk" runat="server" Text="" Visible="false"></asp:Label>
									</div>
								</div>
								...
								<div class="col-md-12 col-sm-12  form-group" id="sftysupvrow" runat="server" visible="false">
									...
									<div class="col-md-6 col-sm-6">
										<asp:DropDownList ID="DDL_SftySupv" runat="server" class="form-control form-control-sm rounded" Enabled="false"></asp:DropDownList>
										...
										<asp:Label ID="lbl_sftysupwrk" runat="server" Text="" Visible="false"></asp:Label>
									</div>
								</div>
							...
							<div class="row" id="TBTID_CreatedMsg" runat="server" visible="false">
								<div class="col-md-12 col-sm-12" style="vertical-align: middle; text-align: center;">
									...
									<asp:Label ID="lbl_TBTID" runat="server" Text="" Visible="false"></asp:Label>
								</div>
							</div>
							...
							<div class="row" id="TBTPanel2" runat="server" visible="false">
								...
								<div class="col-md-12 col-sm-12  form-group">
									<asp:Label ID="Label3" class="col-form-label col-md-9 col-sm-9" runat="server" Font-Bold="true">3. Items of Saftey Interest to this Group :</asp:Label>
									<div class="col-md-3 col-sm-3">
							...
							<div class="col-md-6 center-margin" id="SavePanel2Data" runat="server" visible="false">
								...
								<div class="item form-group row">
									<div class="col-md-6 col-sm-12">
										<asp:Label ID="Label10" runat="server" Text="Click PROCEED to SAVE Data!!"></asp:Label>
									</div>
									<div class="col-md-6 col-sm-12">
										<%--<button type="button" class="btn btn-danger btn-sm collapse-link">Cancel</button>
										<button type="reset" class="btn btn-warning btn-sm">Reset</button>--%>
							...
							<%--ADD button-2 start--%>
							<div class="col-md-6 center-margin" id="UpdatePanel2Data" runat="server" visible="false">
								<div class="ln_solid"></div>
								<div class="item form-group row">
									<div class="col-md-6 col-sm-12">
										<asp:Label ID="Label14" runat="server" Text="Click PROCEED to SAVE Data!!"></asp:Label>
									</div>
									<div class="col-md-6 col-sm-12">
										<%--<button type="button" class="btn btn-danger btn-sm collapse-link">Cancel</button>
										<button type="reset" class="btn btn-warning btn-sm">Reset</button>--%>
										<asp:Button ID="btn_updtpnl2dta" runat="server" Text="MODIFY" Enabled="true" CausesValidation="true" CssClass="btn btn-primary btn-sm" OnClick="btn_updtpnl2dta_Click" />
										<asp:Button ID="btn_cnclpnl2updt" runat="server" Text="Cancel Update" Enabled="true" Visible="false" CausesValidation="true" CssClass="btn btn-warning btn-sm" OnClick="btn_cnclpnl2updt_Click" />
									</div>
								</div>
							</div>
							<%--ADD button-2 end--%>
							...
							<div class="col-md-6 center-margin" id="SavePanel3Data" runat="server" visible="false">
								...
								<div class="item form-group row">
									<div class="col-md-6 col-sm-12">
										<asp:Label ID="Label12" runat="server" Text="Click PROCEED to UPLOAD Photo!!"></asp:Label>
									</div>
									<div class="col-md-6 col-sm-12">
										<button type="button" class="btn btn-danger btn-sm collapse-link">Cancel</button>
										<button type="reset" class="btn btn-warning btn-sm">Reset</button>
										<asp:Button ID="btn_saveTBTPhoto" runat="server" Text="PROCEED" Enabled="true" CssClass="btn btn-success btn-sm" CausesValidation="false" OnClick="btn_saveTBTPhoto_Click1" />
									</div>
								</div>
							</div>
							<%--ADD button-3 end--%>
							...
							<div class="row" id="TBTPhotoUploaded" runat="server" visible="false">
								<div class="col-md-12 col-sm-12" style="vertical-align: middle; text-align: center;">
									...
									<asp:Label ID="Label11" runat="server" Text="Photograph Uploaded Successfully...!" Font-Bold="true" Font-Size="Medium"></asp:Label>
							...
							<div class="col-md-6 center-margin" id="TBTFinalStep" runat="server" visible="false">
								...
								<div class="item form-group row">
									...
									<div class="col-md-6 col-sm-12">
										<button type="button" class="btn btn-danger btn-sm collapse-link">Cancel</button>
										<button type="reset" class="btn btn-warning btn-sm">Reset</button>
										<asp:Button ID="btn_finalstep" runat="server" Text="FINISH" Enabled="true" CssClass="btn btn-success btn-sm" OnClick="btn_finalstep_Click" CausesValidation="false" />
									</div>
								</div>
							</div>
							<%--ADD button-4 end--%>

							<div class="col-md-12 center-margin" id="Div6" runat="server" visible="true">
								<div class="ln_solid"></div>
							</div>


							<%--ADD button-5 start--%>
							<div class="row col-md-12 center-margin" id="SafetySupvApp" runat="server" visible="false">
								<div class="ln_solid"></div>
								<div class="form-group row col-md-12">
									<div class="col-md-6 col-sm-12 form-group" runat="server" visible="false">
										<asp:DropDownList ID="DDL_SSActions" runat="server" Visible="true" class="form-control form-control-sm rounded">
											<asp:ListItem Selected="True">--Select--</asp:ListItem>
											<asp:ListItem>Approve</asp:ListItem>
											<asp:ListItem>Return</asp:ListItem>
											<asp:ListItem>Rejected</asp:ListItem>
										</asp:DropDownList>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ForeColor="Red" ErrorMessage="*Required" ControlToValidate="DDL_SSActions" ValidationGroup="SS_App" InitialValue="--Select--" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
									</div>
									<div class="col-md-3 col-sm-12  form-group">
										<label>Saftey Supervisor Remarks (If Any) </label>
									</div>

									<div class="col-md-3 col-sm-12  form-group">
										<asp:TextBox ID="txt_remarks" class="form-control form-control-sm rounded" Text="N/A" TextMode="MultiLine" runat="server"></asp:TextBox>
									</div>

									<div class="col-md-3 col-sm-12 form-group">
										<asp:Button ID="btnsupv_approve" runat="server" Text="Approve" Enabled="true" CssClass="btn btn-success btn-sm" CausesValidation="false" OnClick="btnsupv_approve_Click" />
										<asp:Button ID="btnsupv_reject" runat="server" CausesValidation="false" ValidationGroup="SO_App" Text="Reject" Enabled="true" CssClass="btn btn-danger btn-sm" OnClick="btnsupv_reject_Click" />
										<asp:Button ID="btnsupv_return" runat="server" CausesValidation="false" Text="Retun" Enabled="true" CssClass="btn btn-warning btn-sm" OnClick="btnsupv_return_Click" />
									</div>
									<div class="col-md-3 col-sm-12  form-group">
										<label>&nbsp;</label>
									</div>
									...
									<div class="col-md-6 col-sm-12">
										<asp:Button ID="btn_home1" runat="server" Text="HOME" Enabled="true" CssClass="btn btn-info btn-sm" CausesValidation="false" PostBackUrl="~/bussiness/production/homepage.aspx" />
										<asp:Button ID="btn_back" CausesValidation="false" runat="server" Text="BACK" Enabled="true" CssClass="btn btn-primary btn-sm" PostBackUrl="~/bussiness/production/vw_tbtforapproval.aspx" />
										<asp:Button ID="btn_approve" runat="server" CausesValidation="true" Visible="false" ValidationGroup="SS_App" Text="Approve TBT" Enabled="true" CssClass="btn btn-primary btn-sm" OnClick="btn_approve_Click" />
									</div>
								</div>
							</div>
							<%--ADD button-5 end--%>
							...
							<%--ADD button-6 start--%>
							<div class="row col-md-12 center-margin" id="SafetyOfficerAppRow" runat="server" visible="false">
								<div class="ln_solid"></div>
								<div class="form-group row col-md-12">
									<div class="col-md-6 col-sm-12" runat="server" visible="false">
										<asp:DropDownList ID="DDL_SftyOfcrApp" runat="server" Visible="true" class="form-control form-control-sm rounded">
											<asp:ListItem Selected="True">--Select--</asp:ListItem>
											<asp:ListItem>Approve</asp:ListItem>
											<asp:ListItem>Return</asp:ListItem>
											<asp:ListItem>Rejected</asp:ListItem>
										</asp:DropDownList>
										<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ForeColor="Red" ErrorMessage="*Required" ControlToValidate="DDL_SftyOfcrApp" ValidationGroup="SO_App" InitialValue="--Select--" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
									</div>

									<div class="col-md-3 col-sm-12  form-group">
										<label>Safety Officer Remarks (If Any) </label>
									</div>

									<div class="col-md-3 col-sm-12  form-group">
										<asp:TextBox ID="txt_sftyofcrrmrks" class="form-control form-control-sm rounded" Text="N/A" TextMode="MultiLine" runat="server"></asp:TextBox>
									</div>

									<div class="col-md-3 col-sm-12 form-group">
										<asp:Button ID="btnofc_app" runat="server" Text="Approve" Enabled="true" CssClass="btn btn-success btn-sm" CausesValidation="false" OnClick="btnofc_app_Click"/>
										<asp:Button ID="btnofc_reject" runat="server" CausesValidation="false" ValidationGroup="SO_App" Text="Reject" Enabled="true" CssClass="btn btn-danger btn-sm" OnClick="btnofc_reject_Click" />
										<asp:Button ID="btnofc_return" runat="server" CausesValidation="false" Text="Retun" Enabled="true" CssClass="btn btn-warning btn-sm" OnClick="btnofc_return_Click"/>
									</div>
									...
									<div class="col-md-6 col-sm-12">
										<asp:Button ID="btn_home2" runat="server" Text="HOME" Enabled="true" CssClass="btn btn-danger btn-sm" CausesValidation="false" PostBackUrl="~/bussiness/production/homepage.aspx" />
										<asp:Button ID="btn_sftyofcrapp" runat="server" CausesValidation="true" ValidationGroup="SO_App" Text="Approve TBT" Visible="false" Enabled="true" CssClass="btn btn-primary btn-sm" OnClick="btn_sftyofcrapp_Click" />
										<asp:Button ID="btn_sftyofcrapprvd" CausesValidation="false" runat="server" Text="BACK" Enabled="true" CssClass="btn btn-success btn-sm" PostBackUrl="~/bussiness/production/vw_tbt_masterapproval.aspx" />
									</div>
								</div>
							</div>
							<%--ADD button-6 end--%>

							<div class="col-md-12 center-margin" id="Div2" runat="server" visible="true">
								<div class="ln_solid"></div>
							</div>

							<div class="col-md-12" id="Div1" runat="server" visible="true">
								<div class="col-md-6 col-sm-12" style="vertical-align: middle; text-align: left;">
									<table border="0">
										<thead>
											<tr>
												<th colspan="5" style="color: black; text-decoration: underline;">Safety Supervisor Approval :</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td rowspan="5">
													...
													<asp:Image ID="pen1" runat="server" ImageUrl="~/erp_images/pending.png" Width="100px" Height="100px" Visible="false" />
												</td>
											</tr>
											<tr>
												<td style="width: 40%;">
												...
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftysupvname" runat="server" Text="Label" Font-Bold="true" ForeColor="blue"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
													<asp:Label ID="Label17" runat="server" Text="Status :"></asp:Label></td>
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftysupvapp" runat="server" Text="Label" Font-Bold="true"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
													<asp:Label ID="Label19" runat="server" Text="Approval Date :"></asp:Label></td>
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftysupvdt" runat="server" Text="Label" Font-Bold="true"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
													<asp:Label ID="Label21" runat="server" Text="Remarks :"></asp:Label></td>
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftysupvrmrks" runat="server" Text="Label" Font-Bold="true"></asp:Label></td>
											</tr>
										</tbody>
									</table>
								...
								<div class="col-md-6 col-sm-12" style="vertical-align: middle; text-align: left;">
									<table>
										<thead>
											<tr>
												<th colspan="5" style="color: black; text-decoration: underline;">Safety Officer Approval</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td rowspan="5">
													...
													<asp:Image ID="pen2" runat="server" ImageUrl="~/erp_images/pending.png" Width="100px" Height="100px" Visible="false" />
												</td>
											</tr>
											<tr>
												<td style="width: 40%;">
												...
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftyofcrname" runat="server" Text="Label" Font-Bold="true" ForeColor="DarkBlue"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
													<asp:Label ID="Label25" runat="server" Text="Status :"></asp:Label></td>
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftyofcrapp" runat="server" Text="Label" Font-Bold="true"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
													<asp:Label ID="Label27" runat="server" Text="Approval Date :"></asp:Label></td>
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftyofcrdt" runat="server" Text="Label" Font-Bold="true"></asp:Label></td>
											</tr>
											<tr>
												<td style="width: 40%;">
												...
												<td style="width: 60%;">
													<asp:Label ID="lbl_sftyofcrrmrks" runat="server" Text="Label" Font-Bold="true"></asp:Label>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div class="col-md-12 center-margin" id="Div3" runat="server" visible="true">&nbsp;</div>

							<%--ADD button-6 start--%>
							<div class="col-md-6 center-margin" id="Div4" runat="server" visible="true">
								<div class="ln_solid"></div>
								<div class="item form-group row">
									<div class="col-md-6 col-sm-12">
										<asp:Button ID="btn_homepage" runat="server" Text="HOME" Enabled="true" CssClass="btn btn-danger btn-sm" CausesValidation="false" PostBackUrl="~/bussiness/production/homepage.aspx" />
										<asp:Button ID="btn_backpage" runat="server" CausesValidation="false" Text="Go Back" Enabled="true" CssClass="btn btn-primary btn-sm" OnClick="btn_backpage_Click" />
									</div>
								</div>
							</div>
							<%--ADD button-6 end--%>
