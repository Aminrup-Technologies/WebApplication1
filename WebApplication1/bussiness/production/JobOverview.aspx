<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="JobOverview.aspx.cs" Inherits="WebApplication1.bussiness.production.JobOverview" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        const myEmbeddedId = "e89ecc96-596b-4036-a90d-2c7879735715"; 
        ...
        async function fetchGuestTokenFromBackend() {
            try {
                ...
                const response = await fetch('JobOverview.aspx/FetchSupersetGuestToken', {
                    method: 'POST',
                    headers: {
