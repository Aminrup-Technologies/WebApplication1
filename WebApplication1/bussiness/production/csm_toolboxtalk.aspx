					...
					<div class="x_panel">
						...
						<div class="x_content">
							...
							<div class="row" id="TBTPanel2" runat="server" visible="false">
								...
								<div class="col-md-12 col-sm-12  form-group">
									<asp:Label ID="Label3" class="col-form-label col-md-9 col-sm-9" runat="server" Font-Bold="true">3. Items of Saftey Interest to this Group (applicable to this group's work area) :</asp:Label>
									<div class="col-md-3 col-sm-3">
