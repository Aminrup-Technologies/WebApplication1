<%@ Page Title="" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="work_company.aspx.cs" Inherits="WebApplication1.bussiness.production.company" %>
		...
		<div class="">
			...
			<div class="row">
						...
						<div class="x_content">
							<div class="row">
							   ...
							   <div class="col-md-3 col-sm-12  form-group">
								...
								<div class="col-md-3 col-sm-12  form-group">
									<asp:TextBox ID="txt_countryname" class="form-control form-control-sm rounded" placeholder="Enter Country Name..." runat="server"></asp:TextBox>
									<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" CssClass="text text-warning" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="txt_countryname" SetFocusOnError="true"></asp:RequiredFieldValidator>
									<small class="form-text text-muted ml-4">Example : India</small>
								</div>
								...
								<div class="col-md-3 col-sm-12  form-group">
									...
									<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"  CssClass="text text-warning" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="txt_countrycode" SetFocusOnError="true"></asp:RequiredFieldValidator>
									<small class="form-text text-muted ml-4">Example : IN</small>
								</div>


								<div class="col-md-3 col-sm-12  form-group">
									<label>Work company Name <span class="text text-danger">*</span></label>
								</div>
								<div class="col-md-3 col-sm-12  form-group">
									<asp:TextBox ID="txt_companyname" class="form-control form-control-sm rounded" placeholder="Enter Country Name..." runat="server"></asp:TextBox>
									<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="txt_companyname" SetFocusOnError="true"></asp:RequiredFieldValidator>
									<small class="form-text text-muted ml-4">Example : India</small>
								</div>
								...
								<div class="col-md-3 col-sm-12  form-group">
									<label>Work company Code <span class="text text-danger">*</span></label>
								</div>
								<div class="col-md-3 col-sm-12  form-group">
									<asp:TextBox ID="txt_companycode" class="form-control form-control-sm rounded" placeholder="Enter Country Short Code..." runat="server"></asp:TextBox>
									<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ErrorMessage="This field is required" ForeColor="Red" ControlToValidate="txt_companycode" SetFocusOnError="true"></asp:RequiredFieldValidator>
									<small class="form-text text-muted ml-4">Example : IN</small>
								</div>
							</div>
				...
				<div class="col-md-12 col-sm-12  ">
					<div class="x_panel">
						<div class="x_title">
							<h2>View and Manage : Work Company</h2>
							<ul class="nav navbar-right panel_toolbox">
								<li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a></li>
								<%--<li><a class="close-link"><i class="fa fa-close"></i></a></li>--%>
							</ul>
									...
									<div class="card-box table-responsive">
										<asp:GridView ID="GridView1" runat="server" Width="100%" class="table table-striped table-hover table-bordered table-responsive table-sm dt-responsive nowrap" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" EmptyDataText="No Data Found">
											<Columns>
												...
												<asp:TemplateField HeaderText="Work Region Code" HeaderStyle-Width="10%">
													<ItemTemplate>
