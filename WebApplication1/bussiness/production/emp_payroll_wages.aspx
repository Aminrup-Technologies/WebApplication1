                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-12  form-group">
                                    <asp:TextBox ID="txt_WagesRate" class="form-control form-control-sm rounded" placeholder="Enter WagesRate..." runat="server"></asp:TextBox>
                                ...
                                <div class="col-md-3 col-sm-12  form-group">
                                    <asp:TextBox ID="txt_VDARate" class="form-control form-control-sm rounded" placeholder="Enter VDARate..." runat="server"></asp:TextBox>
