        ...
        <div class="modal fade bs-pass-modal-lg" id="myModal3" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10 form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ValidationGroup="OLDPASS" ForeColor="IndianRed" ErrorMessage="Required" InitialValue="" Display="Dynamic" ControlToValidate="txt_oldpass" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>

                                    <div class="col-md-4 form-group">
                                        <label>Click<span class="text text-danger">*</span></label>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="btn_closecvpass" runat="server" Text="Close" Visible="true" CausesValidation="false" class="btn btn-danger btn-sm" data-dismiss="modal" Enabled="true" />
