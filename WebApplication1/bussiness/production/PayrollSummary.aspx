<%@ Page Title="Payroll Summary" Language="C#" MasterPageFile="~/bussiness/production/webmaster.Master" AutoEventWireup="true" CodeBehind="PayrollSummary.aspx.cs" Inherits="WebApplication1.bussiness.production.PayrollSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        const myEmbeddedId = "d4a3719c-a6f4-404e-ad3a-a48d1055921a"; 
        ...
        async function fetchGuestTokenFromBackend() {
            try {
                ...
                const response = await fetch('PayrollSummary.aspx/FetchSupersetGuestToken', {
                    method: 'POST',
                    headers: {
