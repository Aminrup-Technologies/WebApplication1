<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="atsweb.Admin.current_openings" %>
                                ...
                                <div class="card-block">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-4 col-lg-4">
                                            <h4 class="sub-title">Current Openings</h4>
                                            <div>

                                                <div class="form-group">
                                                    <label>Openings Name</label>
                                                    <div>
                                                        <asp:TextBox ID="txtName" runat="server" CssClass="form-control"
                                                            placeholder="Enter Openings Name" required=""> </asp:TextBox>
                                                        <asp:HiddenField ID="hdnID" runat="server" Value="0" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <lebel> Openings Image</lebel>
                                                    <div>
                                        ...
                                        <div class="col-sm-6 col-md-8 col-lg-8 mobile-inputs">
                                            <h4 class="sub-title"> Openings Lists</h4>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton ID="LinkEdit" Text="Edit" runat="server" CommandName="edit"
                                                                        CssClass="badge badge-primary" CommandArgument='<%# Eval("CategoryId")%>'>
                                                                         <i class="ti-pencil"></i>
                                                                    </asp:LinkButton>
